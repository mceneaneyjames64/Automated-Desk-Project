...
# Map each sensor to its motor commands
# SENSOR_ADXL is mapped here so move_to_angle() can resolve it the same
# way that move_to_distance() resolves distance sensors.
SENSOR_MOTOR_COMMANDS = {
    ...
    SENSOR_ADXL:   {"extend": CMD_M3_EXTEND, "retract": CMD_M3_RETRACT},
}
