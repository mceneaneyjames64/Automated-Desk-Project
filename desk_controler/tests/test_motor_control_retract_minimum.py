...
def test_retract_fully_stops_at_raw_minimum():
    ...
    with patch.object(
        ...
        result = motor_control.retract_fully(
            sensors={motor_control.config.SENSOR_VL53_0: object()},
